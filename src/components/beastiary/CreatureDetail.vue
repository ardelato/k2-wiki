...
<template>
  <div class="detail-panel">
        ...
        <div class="detail-meta">
          ...
          <div class="meta-item">
            ...
            <span class="meta-value">
              <span v-for="t in creature.types" :key="t" :style="{ color: typeColorMap[t] }"
                >{{ t }}
              </span>
            </span>
          </div>
    ...
    <div class="section">
      ...
      <div class="prof-grid">
        <ProficiencyRing
          v-for="(value, key) in creature.jobs"
          :key="key"
          :label="jobLabels[key as keyof Jobs]"
          :value="value"
          :color="jobColors[key as keyof Jobs]"
          size="sm"
        />
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="cost-list">
        <router-link
          v-for="(cost, i) in creature.summoningCost"
          :key="i"
          :to="{ path: '/items', query: { item: cost.id } }"
          class="cost-item font-mono"
